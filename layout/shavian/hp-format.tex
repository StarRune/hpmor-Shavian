...
, UprightFont=*-Regular
, ItalicFont=*-Italic
%, ItalicFeatures={ AutoFakeSlant = 0.2, AutoFakeBold = 0.8 }
%, AutoFakeBold = 0.4
%, AutoFakeSlant = 0.25
, SmallCapsFont=*-Accent
%, SmallCapsFeatures = { AutoFakeBold = 0.4 }
]{OrminHP}


\linespread{1.3}

\newfontface\hpfont[ExternalLocation, Scale=1.45]{ShawCurly-Regular.otf}
