...
\fontspec[ExternalLocation]{stampatello-faceto.otf}\scriptsize%
...
\pagebreak[1]\fontspec[ExternalLocation,Scale=1.5]{DoolittleGaramondHP-Italic.otf}%
\small#1\nopagebreak[4]\par%
}

% \letterClosing
\newcommand{\letterClosing}[2][\vskip 1\baselineskip]{%
\nopagebreak[4]\fontspec[ExternalLocation,Scale=1.5]{DoolittleGaramondHP-Italic.otf}%
\par\small#1%
\par\nopagebreak[5]#2%
}
